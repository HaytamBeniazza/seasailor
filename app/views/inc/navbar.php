  ...
  <div class="container">
    ...
    <?php if(isset($_SESSION['role']) && ($_SESSION['role'] == 0)) : ?>
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          ...
          <li class="nav-item">
            <a class="nav-link" href="<?php echo URLROOT; ?>/pages/myreservations">MyReservations</a>
          </li>
      </ul>
      <?php elseif(isset($_SESSION['role']) && ($_SESSION['role'] != 0)): ?>
        ...
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          ...
          <li class="nav-item">
            <a class="nav-link" href="<?php echo URLROOT; ?>/pages/myreservations">My Reservations</a>
          </li>
          <li class="nav-item">
      ...
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          ...
          <li class="nav-item">
            <a class="nav-link" href="<?php echo URLROOT; ?>/users/login">Contact</a>
          </li>
      </ul>
      <?php endif; ?>
